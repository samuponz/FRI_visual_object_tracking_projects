...
from ms_tracker import MSParams, MeanShiftTracker
...
def test_tracker(dataset_path, sequence_name, tracker_parameters, setup_parameters):
    ...
    # Create parameters and tracker objects
    parameters = MSParams(**tracker_parameters)
...
if __name__ == '__main__':
    ...
    dataset_path = \
        ...
        'Advanced Topics in Computer Vision/Projects/Project 2/vot2014/'
    ...
    setup_parameters = {
        ...
        'reinitialize': True,
        'show_sequence': True,
        'show_gt': False,  # Flag for drawing the groundtruth bounding box
        'video_delay': 10,
    ...
    for i in np.arange(len(VOT14_sequences)):
        test_tracker(dataset_path, VOT14_sequences[i], ms_tracker_parameters1, setup_parameters)
