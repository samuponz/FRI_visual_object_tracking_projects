...
from tracker_copy import DCFParams, DCFTracker
...
def test_tracker(dataset_path, sequence_name, tracker_parameters, setup_parameters):
    ...
    # Create parameters and tracker objects
    parameters = DCFParams(**tracker_parameters)
...
if __name__ == '__main__':
    ...
    name = 'fish2'
    test_tracker(dataset_path, name, dcf_tracker_parameters1, setup_parameters)

    # Test the algorithm with standard parameters on all the VOT sequences
    # for i in np.arange(len(VOT14_sequences)):
    #     test_tracker(dataset_path, VOT14_sequences[i], dcf_tracker_parameters1, setup_parameters)
